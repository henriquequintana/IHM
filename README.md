...
O sistema realiza uma análise inicial do perfil do usuário e fornece informações sobre a quantidade ideal de calorias a serem consumidas diariamente, além de sugerir alimentos compatíveis com seus objetivos.
...
Fornecer recomendações alimentares personalizadas.


Permitir acompanhamento da evolução alimentar.
...
A análise das respostas permitiu identificar:

Dificuldades em manter uma dieta consistente.


Interesse em monitorar calorias consumidas.


Necessidade de acompanhar progresso e evolução.
...
Permite liberdade na escolha dos alimentos.
...
Criação de mockups digitais.


Desenvolvimento da interface final.
...
Ferramentas de prototipação (Mockups)
...
Cálculo de consumo calórico diário
